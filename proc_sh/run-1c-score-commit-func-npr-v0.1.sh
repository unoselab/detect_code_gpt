...
#   proc_sh/run-1c-score-commit-func-npr-v1.sh
#
# Canonical path:
...
#
# Main outputs:
#   output/commit_function/run-1c/pilot200-dual-profile-v1/
...
OUTPUT_DIR="${OUTPUT_DIR:-output/commit_function/run-1c/pilot200-dual-profile-v1}"
...
LOG_FILE="${LOG_FILE:-${LOG_DIR}/run-1c-score-commit-func-npr-pilot-v1-${TIMESTAMP}.log}"
...
read -r STATUS FAILED_CHECKS SELECTED SUCCESSFUL FAILED EXPECTED_WINDOWS SCORED_WINDOWS SCORED_THIS_RUN REUSED_THIS_RUN MODEL_LOADED < <(
