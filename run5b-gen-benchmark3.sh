...
# ~/project-workspace/ai_detector/src/code-analyzer-tree-sitter/data_codesearchnet/starcoder2-15b-instruct-v0.1/validsyntax_4500_complexity/codesearchnet_starcoder2-15b-instruct-v0.1_python_merged_4500.csv
...

{
  ...
  python generate_mixedcode_benchmark.py \
    ...
    --out_dir "${OUTPUT_DIR}" \
    --only_targets 190 \
    --bucket_width_overrides 190:15 \
    --exclude_used_dir "${OUTPUT_DIR}" \
    --exclude_roles AGC \
    --type_suffix new1 \
    --files_per_type 5 \
    --seed 4
